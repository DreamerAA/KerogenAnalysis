...
def extanded_struct_extr(path_to_structure: str, path_to_save:str, mfilter) -> None:
    start_time = time.time()
    ...
    for num, atoms, size in structures:
        ...
        bbox = Segmentator.box_cell(size)  # type: ignore
        ...
        binarized_file_name = (
            # f"../data/Kerogen/result_img_{file_name}_rs={ref_size}_mr={methan_radius}_div={div}.npy"
            path_to_save + f"./result_img_num={num}_is={img_size}_ar={additional_radius}_resolution={str_resolution}.npy"
        )
        ...
        raw_file_name = (
            # f"../data/Kerogen/result_raw_img_{file_name}_is={img.shape}_mr={methan_radius}_div={div}.raw"
            path_to_save + f"./result_raw_img_num={num}_is={img.shape}_mr={additional_radius}_resolution={str_resolution}a.raw"
        )
...
if __name__ == '__main__':
    ...
    extanded_struct_extr(args.structure_path, args.save_path, mfilter)
