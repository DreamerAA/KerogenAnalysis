...
python -m gex.corrfunc_krg_mol_plotter ${DATA_PATH_CH4}/trj_krg/krg_99.gro ${DATA_PATH_CH4}/figs/corrfunc_krg_99.svg ${DATA_PATH_CH4}/msd/krg_99.pickle

### Построение Корреляционной функции структуры керогена

python -m gex.corrfunc_struct_plotter ${DATA_PATH_CH4}/bin_images ${DATA_PATH_CH4}/ct_pore.npy ${DATA_PATH_CH4}/../figs/corrfunc.svg --trj ${DATA_PATH_CH4}/../ch4/trj.gro:CH4 --trj ${DATA_PATH_CH4}/../h2/trj.gro:H2 --pore --max-t 2.8
